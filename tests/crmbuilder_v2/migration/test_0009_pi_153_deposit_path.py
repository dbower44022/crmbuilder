...
_MIGRATION_0046 = "0008_pi_153_rejected_and_utilization_evidence"
_MIGRATION_0047 = "0009_wtk_089_deposit_event_kind"
...
# create_all no-op path. Postgres DDL (PI-503): TIMESTAMP and a regex CHECK
# where the SQLite original had DATETIME and GLOB.
...
def test_0046_0047_round_trip_and_check_enforcement() -> None:
    db = fresh_db()
