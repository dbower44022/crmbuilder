...
_DOWN = "0042_pi_301_agent_capability_description"
_MIGRATION = "0043_pi_051_security_rules"
_TABLES = ("field_permission_rules", "field_visibility_rules")




def test_0086_creates_and_drops_security_rule_tables() -> None:
    db = fresh_db()
    ...
    with eng.begin() as c:
        ...
        c.execute(text(
            ...
            "'Mentor — salaryBand', 'ROL-001', 'FLD-001', false, 'candidate', "
