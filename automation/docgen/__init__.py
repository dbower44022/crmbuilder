...
Nine document types are supported, each mapped to a work item type:
    ...
    user_process_guide      user_process_guide
"""
...
class DocumentType(enum.Enum):
    """The nine document types supported by the Document Generator."""
...
DOCUMENT_TYPE_TO_WORK_ITEM_TYPE: dict[DocumentType, str] = {
    ...
    DocumentType.USER_PROCESS_GUIDE: "user_process_guide",
}
