...
class TestNavigationStack:
    ...
    def test_initial_depth(self):
        root = NavEntry("Requirements Dashboard", "dashboard")
    ...
    def test_breadcrumbs_returns_all_entries(self):
        ...
        assert len(crumbs) == 2
        assert crumbs[0].label == "Requirements Dashboard"
...
class TestBuildBreadcrumbText:
    ...
    def test_single_entry(self):
        root = NavEntry("Requirements Dashboard", "dashboard")
        stack = NavigationStack(root)
        assert build_breadcrumb_text(stack) == "Requirements Dashboard"

    def test_multiple_entries(self):
        root = NavEntry("Requirements Dashboard", "dashboard")
        stack = NavigationStack(root)
        stack.push(NavEntry("Entity PRD: Contact", "work_item"))
        assert build_breadcrumb_text(stack) == "Requirements Dashboard > Entity PRD: Contact"

    def test_custom_separator(self):
        root = NavEntry("Requirements Dashboard", "dashboard")
        stack = NavigationStack(root)
        stack.push(NavEntry("Child", "child"))
        assert build_breadcrumb_text(stack, " / ") == "Requirements Dashboard / Child"
    ...
    def test_three_levels(self):
        ...
        assert result == "Requirements Dashboard > Work Item > Dependency"
