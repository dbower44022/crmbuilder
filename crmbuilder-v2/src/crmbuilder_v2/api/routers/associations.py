    ...
    with writable_session() as s:
        return ok(
            association.create_association(
                ...
                target_kinds=body.association_target_kinds,
                source_label=body.association_source_label,
                target_label=body.association_target_label,
                source_required=body.association_source_required,
                target_required=body.association_target_required,
