...
from crmbuilder_v2.api.schema_base import (  # noqa: E402, F401 — re-exported (PI-513)
    GovernanceEdgeIn,
    _Base,
)
...
# ``GovernanceEdgeIn`` lives in ``api.schema_base`` (PI-513) so segment
# packages can use it without importing this module; re-exported above.
...
# Operate request schemas live in their segment package (PI-513); re-exported
# here for the import paths that predate the package.
from crmbuilder_v2.segments.operate.schemas import (  # noqa: E402, F401
    DeployRunCreateIn,
    InstanceCreateIn,
