...
_SPECS: dict[str, _Spec] = {
    ...
    # RBAC deploy rule (PI-051). No name column — the controlled field is the
    # most informative title slot; deployment_status is the lifecycle status.
    "field_visibility_rule": _Spec(models.FieldVisibilityRule, "field_visibility_rule_identifier", "field_visibility_rule_target_field", "field_visibility_rule_deployment_status", "field_visibility_rule_created_at", "field_visibility_rule_updated_at"),
