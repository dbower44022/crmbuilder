...
# Operate vocabulary lives in its segment package (PI-513); re-exported here
# for the import paths that predate the package, including the two Postgres
# revisions (0031, 0080) that import these sets.
from crmbuilder_v2.segments.operate.vocab import (  # noqa: E402, F401
