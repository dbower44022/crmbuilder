...
see :func:`governance_rules.resolve_overlay`, shared with the rule read path so
a contract and ``GET /governance-rules?resolution=effective`` agree
(REQ-530 / REQ-533, PI-435). Active
...
def resolve_contract(
    ...
    *,
    ...
    visible_rules = governance_rules.resolve_overlay(
