...
_EXPORT_TABLES: list[tuple[str, type]] = [
    ...
    ("engagement_areas", EngagementArea),
    ("topics", Topic),
    ("domains", Domain),
    ("entities", Entity),
    ("processes", Process),
    ...
    # v0.8 governance entity (PI-029, commit.md) — the seventh
    # governance entity type and the first under the Code Change
    # Lifecycle methodology workstream. Registered here in PI-053
    # close-out; was missing originally, so commits.json was never
    # regenerated by the snapshot exporter.
    ("commits", Commit),
