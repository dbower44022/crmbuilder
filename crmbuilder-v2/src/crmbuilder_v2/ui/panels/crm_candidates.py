...
class CrmCandidatesPanel(ListDetailPanel):
    ...
    def __init__(self, client, parent=None):
        ...
        self._new_button = primary_button("New CRM Candidate")
    ...
    def render_detail(
        ...
        outer.addWidget(
            created_updated_section(
                record, "crm_candidate_created_at", "crm_candidate_updated_at"
            )
        )
