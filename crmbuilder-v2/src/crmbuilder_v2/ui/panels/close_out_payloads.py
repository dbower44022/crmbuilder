...
class CloseOutPayloadsPanel(ListDetailPanel):
    ...
    def fetch_records(self) -> list[dict[str, Any]]:
        return self._client.list_close_out_payloads(include_deleted=self._include_deleted)
    ...
    def list_columns(self) -> list[ColumnSpec]:
        return [
            ...
            ColumnSpec(field="close_out_payload_updated_at", title="Updated", width=180),
        ]
