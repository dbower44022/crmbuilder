...
from crmbuilder_v2.segments.client_management.ui.dialogs.engagement_crud import (
    EngagementCreateDialog,
    EngagementEditDialog,
)
from crmbuilder_v2.segments.client_management.ui.dialogs.engagement_delete import (
...
class EngagementsPanel(ListDetailPanel):
    ...
    def _on_new_engagement_clicked(self) -> None:
        ...
        if self._active_context is not None:
            from crmbuilder_v2.segments.client_management.ui.dialogs.new_engagement_dialog import (
                NewEngagementDialog,
            )
