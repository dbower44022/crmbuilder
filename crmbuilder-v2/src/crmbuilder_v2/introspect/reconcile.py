...
# table, read in both directions, so the two can never drift apart. It is
# imported rather than duplicated for exactly that reason.
_ESPO_FIELD_SHAPE = ESPO_FIELD_SHAPE

#: Kind-only view of the table, kept because callers and tests read it.
_FIELD_TYPE_MAP: dict[str, str] = {
    espo: shape["field_type"] for espo, shape in ESPO_FIELD_SHAPE.items()
}
