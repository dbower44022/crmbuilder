...
def migrate_sessions_to_conversations(conn: sqlite3.Connection) -> list[dict]:
    ...
    for row in cur.fetchall():
        ...
        body = {
            ...
            # PI-074 carry-over: preserve executive_summary if the legacy
            # session had one populated. CHECK constraint admits NULL or
            # 200..800 chars; legacy rows without backfill carry NULL.
            "conversation_executive_summary": r.get("executive_summary"),
