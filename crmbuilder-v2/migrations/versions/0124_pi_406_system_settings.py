"""PI-406 (REQ-485 / DEC-918) — governed system settings with per-instance values.
...
SQLite chain head 0123 -> 0124. Companion PG-chain delta:
``migrations/pg/versions/0081_pi_406_system_settings.py``.
...
revision: str = "0124_pi_406_system_settings"
down_revision: str | None = "0123_pi_419_deploy_runs"
