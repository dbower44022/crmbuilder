"""PI-444 (REQ-546 / DEC-977) — per-instance stored feature selection.
...
SQLite chain head 0128 -> 0129. Companion PG-chain delta:
``migrations/pg/versions/0086_pi_444_instance_feature_selection.py``.
...
revision: str = "0129_pi_444_instance_feature_selection"
down_revision: str | None = "0128_pi_442_deploy_server_management_fields"
