...
Revision ID: 0021_pi_073_session_conversation_redesign
Revises: 0020_pi_074_executive_summary
Create Date: 2026-05-27

(Renumbered from 0020 → 0021 at rebase time. Main landed
0020_pi_074_executive_summary in parallel; this migration now revises
that head. The session_executive_summary and conversation_executive_summary
columns are added to the new tables per PI-074 carry-over.)
...
revision: str = "0021_pi_073_session_conversation_redesign"
down_revision: Union[str, None] = "0020_pi_074_executive_summary"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # PI-074 carry-over: TEXT NULL with 200..800 length CHECK.
        # Reconciliation: PI-074 added executive_summary to the legacy
        # sessions table; that table is renamed to legacy_sessions above
        # (so executive_summary travels with the rename). The new
        # sessions entity exposes session_executive_summary for the same
        # audience-readable purpose.
        sa.Column("session_executive_summary", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        # PI-074 carry-over: old SES-NNN rows had executive_summary;
        # they become conversations under PI-073's redesign. Same
        # length-CHECK shape as session_executive_summary.
        sa.Column("conversation_executive_summary", sa.Text(), nullable=True),
        # Classification
