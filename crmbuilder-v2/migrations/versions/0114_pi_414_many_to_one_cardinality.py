"""PI-414 (REQ-506 / DEC-932) — admit ``many_to_one`` as a cardinality.
...
SQLite chain head 0113 -> 0114. Companion PG-chain delta:
``migrations/pg/versions/0071_pi_414_many_to_one_cardinality.py``.
...
revision: str = "0114_pi_414_many_to_one_cardinality"
down_revision: str | None = "0113_pi_414_relationship_link_properties"
