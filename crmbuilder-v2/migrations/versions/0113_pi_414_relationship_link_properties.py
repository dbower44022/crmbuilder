"""PI-414 (REQ-506 / REQ-507, DEC-932) — relationships carry what the link field did.
...
SQLite chain head 0112 -> 0113. Companion PG-chain delta:
``migrations/pg/versions/0070_pi_414_relationship_link_properties.py``.
...
revision: str = "0113_pi_414_relationship_link_properties"
down_revision: str | None = "0112_pi_414_retire_multi_choice_kind"
