"""PI-411 (REQ-496 / DEC-924) — a publish run records the plan it applied.
...
SQLite chain head 0125 -> 0126. Companion PG-chain delta:
``migrations/pg/versions/0083_pi_411_publish_run_plan_fingerprint.py``.
...
revision: str = "0126_pi_411_publish_run_plan_fingerprint"
down_revision: str | None = "0125_pi_438_rule_audience_moment"
