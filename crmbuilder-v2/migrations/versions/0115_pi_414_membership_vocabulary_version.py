"""PI-414 (REQ-504 / DEC-930) — a stored verdict names the vocabulary that produced it.
...
SQLite chain head 0114 -> 0115. Companion PG-chain delta:
``migrations/pg/versions/0072_pi_414_membership_vocabulary_version.py``.
...
revision: str = "0115_pi_414_membership_vocabulary_version"
down_revision: str | None = "0114_pi_414_many_to_one_cardinality"
