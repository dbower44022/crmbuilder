"""PI-442 (REQ-544 / DEC-971) — server-management facts on the deploy records.
...
SQLite chain head 0127 -> 0128. Companion PG-chain delta:
``migrations/pg/versions/0085_pi_442_deploy_server_management_fields.py``.
...
revision: str = "0128_pi_442_deploy_server_management_fields"
down_revision: str | None = "0127_pi_439_rule_enforcement_overrides"
