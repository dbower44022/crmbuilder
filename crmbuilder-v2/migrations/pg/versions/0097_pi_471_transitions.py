...
PG chain head 0096 -> 0097. Companion SQLite-chain delta:
``migrations/versions/0140_pi_471_transitions.py``.
...
revision: str = "0097_pi_471_transitions"
down_revision: str | None = "0096_pi_488_session_opening_fields"
