...
PG chain head 0091 -> 0092. Companion of the SQLite-chain
``0135_pi_413_workflow_membership``.
...
revision: str = "0092_pi_413_workflow_membership"
down_revision: str | None = "0091_pi_412_instance_stamp_reading"
