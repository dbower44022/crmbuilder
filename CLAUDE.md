...
Phase 5:  Entity PRDs               → 1 conversation per entity, drafted
                                       ...
                                       entity are complete
Phase 6:  Domain Reconciliation     → 1 conversation per domain, synthesizes
                                       process docs and Entity PRDs into the
                                       Domain PRD
Phase 7:  Stakeholder Review        → outside Claude, via Google Docs
Phase 8:  Cross-Domain Service      → 1 conversation per service (Notes,
